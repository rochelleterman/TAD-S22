...
---
### Two broad approaches to text as data (machine learning)
...
--
.small[
**5. Validate** by comparing the prediction to "ground truth".
  - Compare predicted response value ( $\hat{Y}$ ) with true response value ( ${Y}$ ) for observations in validation set to evaluate performance.
]
