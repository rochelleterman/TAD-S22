...
.accent[Supervised methods]: Hand coding is used to train, or supervise, statistical models to classify texts in pre-determined categories.
...
.accent[Single Membership Models]

Document -> One Cluster


--
.accent[Mixed Membership Models]

Document -> Multiple Clusters
